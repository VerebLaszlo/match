...
typedef enum {
	ANGLE_TO_COMP = 0, COMP_TO_ANGLE = 1, ETAM_TO_M1M2 = 0, M1M2_TO_ETAM = 1, ETAM = 0, M1M2 = 1
} conversion_Mode;
...
void gen_Mass(binary_System *sys, binary_System *min, binary_System *max, conversion_Mode mode);
...
void gen_Parameters(binary_System *sys, binary_System *min, binary_System *max, conversion_Mode mode);
